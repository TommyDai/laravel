...
<div class="mws-panel-header">
  <span class="mws-i-24 i-list">{{ $cate[0]->name }}--添加子分类</span>
</div>
<div class="mws-panel-body">
  ...
  <form class="mws-form" action="{{ url('admin/cate/add') }}" method="post">
        ...
        <div class="mws-form-item large">
          <div class="mws-form-cols clearfix">
            ...
            <div class="mws-form-col-2-8">
              <label>PID</label>
              <div class="mws-form-item large">
                <input class="mws-textinput" type="text" name="pid" value="{{ $c->id }}" readonly></div>
            </div>
            <div class="mws-form-col-2-8">
              <label>PATH</label>
              <div class="mws-form-item large">
                <input class="mws-textinput" type="text" name="path" value="{{ $c->path }},{{ $c->id }}" readonly></div>
            </div>
    ...
    <div class="mws-button-row">
      ...
      <a href="{{ url('admin/cate/prev') }}/{{ $c->
        pid }}" style="text-decoration:none">
